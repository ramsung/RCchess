/*
    RC Chess - An Android chess program.
...
import org.beyonity.chess.GUIInterface;
import org.beyonity.chess.GUIInterface.ThinkingInfo;
import org.beyonity.chess.GameMode;
import org.beyonity.chess.PGNOptions;
import org.beyonity.chess.Util;
import org.beyonity.chess.book.BookOptions;
import org.beyonity.chess.engine.MaterialComputerPlayer;
import org.beyonity.chess.engine.MaterialComputerPlayer.SearchRequest;
import org.beyonity.chess.engine.MaterialComputerPlayer.SearchType;
import org.beyonity.chess.engine.UCIOptions;
import org.beyonity.chess.gamelogic.Game.GameState;
import org.beyonity.chess.gamelogic.GameTree.Node;
 ...
 * @author petero
 */
public class RCchessController {
    ...
    /** Constructor. */
    public RCchessController(GUIInterface gui, PgnToken.PgnTokenReceiver gameTextListener,
                             PGNOptions options) {
        this.gui = gui;
    ...
    private final class SearchListener implements org.mdc.chess.gamelogic.SearchListener {
