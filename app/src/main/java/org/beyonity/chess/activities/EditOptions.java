...
public class EditOptions extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = getIntent();
        uciOpts = (UCIOptions) i.getSerializableExtra("org.beyonity.chess.ucioptions");
        engineName = (String) i.getSerializableExtra("org.beyonity.chess.enginename");
        if (uciOpts != null) {
            initUI();
        } else {
            ...
            for (String name : uciOpts.getOptionNames()) {
                ...
                switch (o.type) {
                    ...
                    case SPIN: {
                        ...
                        String labelText = String.format(Locale.US, "%s (%d\u2013%d)", so.name,
                                so.minValue, so.maxValue);
    ...
    private final void sendBackResult() {
        if (uciOpts != null) {
            ...
            Intent i = new Intent();
            i.putExtra("org.beyonity.chess.ucioptions", uciMap);
