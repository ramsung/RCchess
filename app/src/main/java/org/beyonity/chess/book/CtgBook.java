...
package org.beyonity.chess.book;
...
class CtgBook implements IOpeningBook {
    ...
    private final static byte[] readBytes(RandomAccessFile f, long offs, int len)
            throws IOException {
...
//                                        w0, recom, score, weight);
    ...
    private final static class CtoFile {
        ...
        final static ArrayList<Integer> getHashIndices(byte[] encodedPos, CtbFile ctb)
                throws IOException {
