...
class PolyglotBook implements IOpeningBook {
    ...
    private final void readEntry(RandomAccessFile f, long entNo, PGBookEntry ent)
            throws IOException {
        f.seek(entNo * 16);
    ...
    private static class PGBookEntry {
        ...
        final Move getMove(Position pos) {
            ...
            switch (prom) {
                case 1:
                    promoteTo = wtm ? Piece.WKNIGHT : Piece.BKNIGHT;
                    break;
                case 2:
                    promoteTo = wtm ? Piece.WBISHOP : Piece.BBISHOP;
                    break;
                case 3:
                    promoteTo = wtm ? Piece.WROOK : Piece.BROOK;
                    break;
                case 4:
                    promoteTo = wtm ? Piece.WQUEEN : Piece.BQUEEN;
                    break;
                default:
