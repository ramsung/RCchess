...
package org.beyonity.chess.engine.cuckoochess;

import android.os.Environment;

import org.beyonity.chess.EngineOptions;
import org.beyonity.chess.engine.LocalPipe;
import org.beyonity.chess.engine.UCIEngineBase;
...
public class CuckooChessEngine extends UCIEngineBase {
    ...
    // Engine data
    private MaterialEngineControl engine;
    ...
    protected File getOptionsFile() {
        ...
        return new File(extDir, "/RCChess/uci/cuckoochess.ini");
    }
...
//        System.out.printf("GUI -> Engine: %s\n", data);
    ...
    private final void initEngine(LocalPipe os) {
        if (engine == null) {
            engine = new MaterialEngineControl(os);
        }
    }
